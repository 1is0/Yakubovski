...
void FillTreeFromTable(TStringGrid *StringGrid1);

// ---------------------------------------------------------------------------
__fastcall TForm1::TForm1(TComponent* Owner) : TForm(Owner) {
	FillTable(StringGrid1);
	FillTreeFromTable(StringGrid1);
...
void __fastcall TForm1::Button7Click(TObject *Sender) {
	ShowMessage("Количество узлов в правом поддереве: " +
		IntToStr(tr.CountNodesInTree(tr.root->pRight)));
}
// ---------------------------------------------------------------------------
